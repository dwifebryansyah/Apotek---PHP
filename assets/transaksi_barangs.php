    ...
    // die();
      ...
      //$cekJumlah = $jumlah <= $jumlah_awal;
  			...
  			if( $subtotal['subtotal'] == 0 ){
  				$sql6 = mysqli_query($conn, "TRUNCATE TABLE tb_struk");//2
                    ...
                    <div class="col-md-3 pl-1">
                      ...
                      <div class="form-group">
				        ...
				        <div class="col-md-2 mt-3" >
  				     	  <button class="btn btn-primary btn-block" name="pilih">Pesan</button>
  			        </div>
				      </div>
            </form>
          </div>
      	...
      	<div class="row">
            ...
            <div class="card p-2">
                  ...
                  <table class="table" style="font-size: 13px;">
                    ...
                    <tbody>
                      ...
                      <?php foreach($query2 as $row): ?>
                        ...
                        <td>
                          <a onclick="return confirm('yakin ingin mengahapus?');" href="../hapus.php?kode=<?='kd_barang'?>&tabel=<?='tb_keranjang'?>&hapus=<?= $row['kd_barang'] ?>&url=<?= 'transaksi/transaksi_barangs' ?>" class="badge badge-danger">hapus</a>
                          <!-- 5 -->
                        </td>
                    	</tr>
                      <?php $i++ ?>
          	...
          	<div class="row">
              	...
              	<div class="col-md-3" >
                   	<input class="btn btn-danger" type="submit" name="selesai" value="Selesai">
                </div>
              </div>
              ...
              <div class="card-body">
                  ...
                  <div class="col-md-5 pr-1">
                    <div class="form-group">
                      ...
                      <?php if( isset($_POST['membayar']) and !is_numeric(@$_POST['bayar']) ) { ?>
                        <input type="text" class="form-control" name="bayar" value="1<?= @$bayar;?>" required>
                        <?= $bayar_error_msg; ?>
                      <?php }elseif ( isset($_POST['selesai']) and !is_null(@$_POST['totals']) and !is_null(@$_POST['total']) ) { ?>
                      <input type="text" class="form-control" name="bayar" value="2<?= @$bayar;?>" required>

                      

                        <?= $bayar_error_msg; ?>
                      <?php }elseif ( is_numeric(@$_POST['bayar']) and @$cek ) { ?>
                      <input type="text" class="form-control" name="bayar" value="3<?= @$bayar;?>" required>
                      <?php }else{ ?>
                ...
                <div class="row">
                  <div class="col-md-3 pl-1 ml-3" >
                      ...
                      <input class="btn btn-primary" type="submit" name="membayar" value="Buy">
                    ...
                    <?php }else{ ?>
                    <input class="btn btn-primary" type="submit" name="membayar" disabled="disabled" value="Buy">
                    <?php } ?>
			           </div>
                </div>
                <div class="row">
                ...
                <div class="row">
                	<div class="col-md-3 pl-1 ml-3" >
                      ...
                      <a href="../FPDF/cetak_struk.php" class="btn btn-primary disabled">
                      Cetak
                    </a>
