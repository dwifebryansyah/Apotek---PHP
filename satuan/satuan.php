<?php 
  ...
  if(!isset($_SESSION['submit'])){
	...
	$satuan = tampil("SELECT * FROM tb_satuan");
    ...
    $params = ['satuan'];
		...
		$satuan = cari($_POST['tsearch'], $table, $kode, $params  );
	}
          ...
          <div class="collapse navbar-collapse justify-content-end" id="navigation">
           ...
           <?php if(isset($_SESSION['tampilan'])): ?>
            ...
            <ul class="navbar-nav">
              ...
              <li class="nav-item">
                <a class="nav-link" href="tambah_satuan.php">
						...
						<div class="col-md-10">
							<ul class="list-group">
								<?php foreach($satuan as $row): ?>
									<li class="list-group-item d-flex justify-content-between align-items-center"><?= $row['satuan'] ?>
							  			<a href="edit_satuan.php?id=<?= $row['kd_satuan']; ?>" class="badge badge-success ml-auto mr-2">Edit</a>

							  			<a onclick="return confirm('yakin ingin mengahapus?');" href="../hapus.php?kode=<?='kd_satuan'?>&tabel=<?='tb_satuan'?>&hapus=<?= $row['kd_satuan'] ?>&url=<?= 'satuan/satuan' ?>" class="badge badge-danger">hapus</a>
							  		</li>
								<?php endforeach; ?>
							</ul>
						</div>
