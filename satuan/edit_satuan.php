<?php 
  ...
  if(!isset($_SESSION['submit'])){
	...
	@$id = $_GET['id'];
	@$satuan = tampil("SELECT * FROM tb_satuan WHERE kd_satuan = '$id'")[0];
			                  ...
			                  <div class="row">
			                    ...
			                    <div class="col-md-8 pr-1">
			                      <div class="form-group">
			                        ...
			                        <input type="text" class="form-control" name="kd_satuan" readonly value="<?= @$satuan['kd_satuan']; ?>">
			                      </div>
			                    </div>
			                  </div>
			                    ...
			                    <div class="col-md-8 pr-1">
			                      <div class="form-group">
			                        ...
			                        <?php if(isset($_POST['update'])){ ?>
									    <input type="text" class="form-control" name="satuan" value="<?= @$nameSatuan; ?>">
									     <?= $satuanErr.$satuanMsg ?>
								 	<?php }else{ ?>
